<%-- 
    Document   : checkout
    Created on : Oct 10, 2023, 10:19:55 PM
    Author     : FPTSHOP
--%>
...
<html lang="en">
    <head>
        ...
        <style>
            ...
            /* Các ô dựng giữa (số lượng sản phẩm) */
            td.quantity {
                text-align: center;
            }
            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        <li class="active"><a  href="product?id=${0}">Categories</a></li>
                        ...
                        <div class="billing-details">
                            <table border="1">
                                ...
                                <c:forEach items="${o.items}" var="i">
                                    ...
                                    <tr>
                                        <td>${tt}</td>
                                        <td><img src="img/${i.product.image}" style="width: 70px;height: 70px"/> </td>
                                        ...
                                        <td style="text-align: center" class="return-button">
...
<!--                            <textarea class="input" placeholder="Order Notes"></textarea>-->
                    ...
                    <div class="col-md-5 order-details">
                        ...
                        <div class="order-summary">
                            ...
                            <div class="order-col">
                                <div><strong>TOTAL</strong></div>
                                <div><strong class="order-total">${o.totalMoney}</strong></div>
                            </div>
                        </div>
