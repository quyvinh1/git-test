                    ...
                    <form action="update" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>ID</label>
                                <input type="text" class="form-control" name="id" readonly value="${p.getId()}">
                            </div>
                            <div class="form-group">
                                <label>Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="category">
                                    ...
                                    <c:forEach items="${data}" var="item">
                                        <c:choose>
                                            <c:when test="${item.getId() eq p.getCategory()}">
                            ...
                            <div class="form-group">
                                <label>Saleoff</label>
                                <input type="text" class="form-control" name="sale" value="${p.getSale()}" required>
                                
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" onclick="backManager()" value="Cancel">
